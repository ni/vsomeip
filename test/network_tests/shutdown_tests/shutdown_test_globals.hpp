...
constexpr uint32_t SHUTDOWN_SIZE_UDS = 1024 * 128;
constexpr uint32_t SHUTDOWN_SIZE_UDP = 1024;
constexpr uint32_t SHUTDOWN_SIZE_TCP = 1024 * 128;
constexpr uint32_t SHUTDOWN_NUMBER_MESSAGES = 5;
